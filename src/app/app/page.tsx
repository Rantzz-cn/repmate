...
export default function TodayPage() {
  ...
  return <div className="app-page">
    ...
    <section className="dashboard-coach">
      <Image src="/assets/images/repmate.webp" width={140} height={150} alt="RepMate coach" className="dashboard-coach__image"/>
      <div className="dashboard-coach__bubble"><p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">RepMate</p><p className="mt-1 text-sm font-medium">{state.activeWorkout?`Your ${state.activeWorkout.name} session is waiting.`:today?`${today.name} is ready when you are.`:"Recovery is part of the work."}</p></div>
    </section>
