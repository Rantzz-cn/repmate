...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (loading || !session) return <div className="grid min-h-dvh place-items-center bg-black"><div className="numeric text-sm text-zinc-500">Loading RepMate</div></div>;
